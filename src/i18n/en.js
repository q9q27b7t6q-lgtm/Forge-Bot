...
module.exports = {
  ...
  landing: {
    ...
    how3_body: 'Invite ForgeBot to your Discord. The bot runs on its own — nothing to install, nobody sets up your server for you.',
    journey_eyebrow: 'Customer journey',
    journey_title: 'From signup to a live bot',
    journey_title_closed: 'Coming soon: from signup to a live bot',
    ...
    j4_title: 'Invite',
    j4_body: 'Invite ForgeBot to your Discord. That’s it: the bot is live, you manage your own FAQ.',
    ...
    p2_l3: 'You set everything up from the dashboard',
    p2_l4: 'Updates included',
    p2_cta: 'Create an account',
    p3_name: 'Studio',
    p3_price: '€19',
    p3_period: '/ month',
